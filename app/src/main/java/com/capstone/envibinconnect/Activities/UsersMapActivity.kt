...
class UsersMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().reference.child("manager")
        ...
        databaseReference.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (placeSnapshot in snapshot.children) {
                    ...
                    gMap.addMarker(MarkerOptions().position(location).title(placeSnapshot.child("email").value.toString()))
                        ?.setIcon(bitmapFromVector(this@UsersMapActivity,
